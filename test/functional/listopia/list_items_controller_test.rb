  ...
  class ListItemsControllerTest < ActionController::TestCase
    ...
    test "should create list_item" do
      assert_difference('ListItem.count') do
        post :create, list_item: { list_id: @list_item.list_id, position: @list_item.position, resource_id: @list_item.resource_id, resource_type: @list_item.resource_type }
      end
    ...
    test "should update list_item" do
      put :update, id: @list_item, list_item: { list_id: @list_item.list_id, position: @list_item.position, resource_id: @list_item.resource_id, resource_type: @list_item.resource_type }
      assert_redirected_to list_item_path(assigns(:list_item))
    end
